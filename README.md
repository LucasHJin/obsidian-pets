...
1. Download the latest release from the [Releases page](https://github.com/miaowuduck/stardew-companions/releases)
...
Found a bug or have a suggestion? Open an issue on [GitHub](https://github.com/miaowuduck/stardew-companions/issues).
